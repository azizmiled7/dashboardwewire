                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                            @if (auth()->user()->role === 'admin')
                                <li><a href="/add-tech" key="t-default">ajouter</a></li>
@endif
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                            @if (auth()->user()->role === 'admin')
                                <li><a href="/add-mate" key="t-default">ajouter</a></li>
@endif
                                <li><a href="/materiels" key="t-crypto">list materiels</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li><a href="/" key="t-default">ajouter</a></li>
@endif
    ...
    @auth
    <script>
        // Badge messages non lus dans le menu
        function fetchUnreadCount() {
            fetch('/contact/unread-count', { headers: {'X-Requested-With': 'XMLHttpRequest'} })
            .then(r => r.json())
            .then(data => {
